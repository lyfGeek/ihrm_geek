package com.geek.generate.ui;

import com.geek.generate.core.GeneratorFacade;
...
//												.addComponent(jTextField4)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        ...
        File directory = new File(new File("").getAbsolutePath() + "\\codeutils\\模板");// 设定为当前文件夹。
        ...
        final Thread t = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    // 获取当前文件夹下的模板目录下的所有文件夹。
                    String basePath = new File("").getAbsolutePath() + "\\codeutils\\模板\\"
                    ...
                    generator(templatePath, outPath, settings, db);
                    JOptionPane.showMessageDialog(null, "代码生成成功。", "提示",
                            JOptionPane.DEFAULT_OPTION);
                } catch (Exception e) {
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(null, "发生错误。", "错误详情请查看 error.log。",
     ...
     */
    private void generator(String templatePath, String outPath, Settings settings, DataBase dataBase) throws IOException {
...
//        System.out.println(settings);
        ...
        try {
            generatorFacade.generateByDatabase();
